...
<head>
    ...
    <title>Admin-Program Kerja</title>
    ...
    <nav class="navbar navbar-light bg-light">
      ...
      <figure>
        <blockquote class="blockquote">
          <p>Program Kerja Dewan Ambalan Priode 2022 - 2023</p>
        </blockquote>
        ...
        <table class="table align-middle table-bordered table-hover table-$purple-700">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="table-light">
                <img src="img/<?php echo $result['gambar_produk']; ?>"  style="width: 50px;">
              </td>
              <td class="table-light">
              <?php echo $result['status']; ?>
              </td>
              <td class="table-light">
              <?php echo $result['warna']; ?>
              </td>
              <td class="table-light">
                <a href="tambah.php?ubah=<?php echo $result['id']; ?>" type="button" class="btn btn-success btn-sm">
                    <i class="fa fa-pencil"></i>
                    Ubah</a>
                    <a href="proses.php?hapus=<?php echo $result['id']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah Anda yakin mau hapus???')">
